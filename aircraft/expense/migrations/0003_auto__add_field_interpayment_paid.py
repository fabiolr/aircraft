...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Interpayment.paid'
        db.add_column('expense_interpayment', 'paid', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Interpayment.paid'
        db.delete_column('expense_interpayment', 'paid')
