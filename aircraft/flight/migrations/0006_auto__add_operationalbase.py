...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'OperationalBase'
        db.create_table('flight_operationalbase', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('base', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['flight.Airport'])),
            ('since', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['flight.Flight'], null=True)),
        ))
        db.send_create_signal('flight', ['OperationalBase'])


    def backwards(self, orm):
        
        # Deleting model 'OperationalBase'
        db.delete_table('flight_operationalbase')
    ...
    models = {
        ...
        'flight.operationalbase': {
            'Meta': {'object_name': 'OperationalBase'},
            'base': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['flight.Airport']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'since': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['flight.Flight']", 'null': 'True'})
        },
        'flight.outage': {
