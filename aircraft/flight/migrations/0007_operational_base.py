...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        base = orm.Airport.objects.get_or_create(icao='SBJD')[0]
        orm.OperationalBase.objects.create(base=base)


    def backwards(self, orm):
        base = orm.Airport.objects.get(icao='SBJD')
        orm.OperationalBase.objects.get(base=base).delete()
