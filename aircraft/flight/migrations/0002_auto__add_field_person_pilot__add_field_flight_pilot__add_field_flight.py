...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Person.pilot'
        db.add_column('flight_person', 'pilot', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Flight.pilot'
        db.add_column('flight_flight', 'pilot', self.gf('django.db.models.fields.related.ForeignKey')(related_name='pilots', null=True, to=orm['flight.Person']), keep_default=False)

        # Adding field 'Flight.copilot'
        db.add_column('flight_flight', 'copilot', self.gf('django.db.models.fields.related.ForeignKey')(related_name='copilots', null=True, to=orm['flight.Person']), keep_default=False)

        # Adding field 'Flight.takeoff_time'
        db.add_column('flight_flight', 'takeoff_time', self.gf('django.db.models.fields.TimeField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Person.pilot'
        db.delete_column('flight_person', 'pilot')

        # Deleting field 'Flight.pilot'
        db.delete_column('flight_flight', 'pilot_id')

        # Deleting field 'Flight.copilot'
        db.delete_column('flight_flight', 'copilot_id')

        # Deleting field 'Flight.takeoff_time'
        db.delete_column('flight_flight', 'takeoff_time')
