...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Flight.remarks'
        db.add_column('flight_flight', 'remarks', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Flight.remarks'
        db.delete_column('flight_flight', 'remarks')
