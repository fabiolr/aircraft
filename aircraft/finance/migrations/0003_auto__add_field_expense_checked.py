...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Expense.checked'
        db.add_column('finance_expense', 'checked', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Expense.checked'
        db.delete_column('finance_expense', 'checked')
